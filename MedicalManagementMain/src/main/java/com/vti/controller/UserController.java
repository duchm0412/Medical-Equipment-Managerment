...
public class UserController {
	...
	public ResponseEntity<?> findUserByEmail(@PathVariable(name = "username") String usernamefind) {
		// get entity
		User result = userService.findUserByUserName(usernamefind);
		...
		User user = new User(userName, email, firstName, phone, lastName, role, status, avatarUrl,address);
		// return result
		return new ResponseEntity<>(user, HttpStatus.OK);
	}

	@GetMapping(value = "/phone/{phone}")
	public ResponseEntity<?> existsUserByPhone(@PathVariable(name = "phone") String phone) {
		// get entity
		boolean result = userService.existsUserByPhone(phone);
	...
	public ResponseEntity<?> getUserProfile(Authentication authentication) {
		...
		ProfileDTO profileDto = new ProfileDTO(user.getUserName(), user.getEmail(), user.getFirstName(),
				user.getLastName(), user.getRole(), user.getStatus().toString(), user.getAvatarUrl());
