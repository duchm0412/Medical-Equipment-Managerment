...
// Landing
import Landing from "../pages/landing/NewLanding";
...
const DepartmentManagerment = async(() =>
  import("../pages/departmentManager/DepartmentManage")
);

const EquipmentManagerment = async(() =>
  import("../pages/equipmentManager/equipmentManager")
);
const StaffManagerment = async(() =>
  import("../pages/staffManager/staffManager.js")
);
const InventoryManager = async(() =>
  import("../pages/inventoryManage/inventoryManager")
);
const Intro = async(() => import("../pages/docs/Introduction"));
// Forms
...
const departmentManagement = {
  ...
  name: "Phòng Ban",
  icon: Home ,
  component: withAuth(DepartmentManagerment),
  children: null,
};
const staffManagement = {
  ...
  name: "Nhân viên",
  icon: Users,
  component: withAuth(StaffManagerment),
  children: null,
};
const inventoryManagement = {
  ...
  name: "Quản lý kho",
  icon: Package,
  component: withAuth(InventoryManager),
  children: null,
};
const equipmentManagerment = {
  ...
  name: "Thiết bị y tế",
  icon: PlusSquare,
  component: withAuth(EquipmentManagerment),
  children: null,
};
...
export const introduction = [introductionRouter];
